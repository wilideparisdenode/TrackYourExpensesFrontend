...
const Dashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const [budgetsResponse, expensesResponse, incomeResponse] =
        await Promise.all([
  ...
  <div className="financial-summary-grid">
    <div className="summary-card income-card">
      ...
      <div className="card-content">
        ...
        <p className="card-amount">
          {preferences.symbol}{dashboardData.totalIncome.toLocaleString('en-US', { 
    ...
    <div className="summary-card expense-card">
      ...
      <div className="card-content">
        ...
        <p className="card-amount">
           {preferences.symbol}{dashboardData.totalExpenses.toLocaleString('en-US', { 
            minimumFractionDigits: 2, 
            maximumFractionDigits: 2 
          })}
        </p>
    ...
    <div className={`summary-card balance-card ${balance >= 0 ? "positive" : "negative"}`}>
      ...
      <div className="card-content">
        ...
        <p className="card-amount">
           {preferences.symbol}{balance.toLocaleString('en-US', { 
            minimumFractionDigits: 2, 
            maximumFractionDigits: 2 
          })}
        </p>
        <p className="card-trend">
          {balance >= 0 ? (
            <>
              <ArrowUpRight size={14} /> 
              <span>{balancePercentage}% of income</span>
            </>
          ) : (
            <>
              <ArrowDownRight size={14} /> 
            ...
            <div key={index} className="transaction-item">
              ...
              <div className="transaction-details">
                <span className="transaction-title">
                  {item.description || item.source || "Transaction"}
                </span>
              ...
              <div key={index} className="budget-item">
                <div className="budget-info">
                  ...
                  <div className="budget-meta">
                    <span className="budget-spent"> {preferences.symbol}{budget.spent}</span>
                    <span className="budget-total">of  {preferences.symbol}{budget.amount}</span>
                  </div>
                </div>
